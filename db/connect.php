...
$products = [
    ...
    ["Travis Scott Air Max 270 'Cactus Trails'", 'The sneaker upper features wavy cream synthetic overlays sitting atop the tonal mesh base while a brown nubuck toe cap with mini embroidered Swoosh branding adds contrast.', 8888, 'Nike x', 'src/images/sneakers/travis-scott-cactus.png'],
