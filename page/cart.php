    ...
    <div class="w-3/4 border-x border-black bg-white px-10 py-10">
      ...
      <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
        <div class="flex w-2/5"> <!-- product -->
          <div class="w-auto">
            <img class="w-auto h-32" src="src/images/sneakers/dunk.png" alt="">
          </div>
          <div class="flex flex-col justify-center ml-4 flex-grow">
            <span class="font-bold text-sm">Nike Dunk Low</span>
            <span class="text-red-500 text-xs">UK 9</span>
          </div>
        </div>
      ...
      <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
        <div class="flex w-2/5"> <!-- product -->
          <div class="w-auto">
            <img class="w-auto h-32" src="src/images/sneakers/mummy.png" alt="">
          </div>
          <div class="flex flex-col justify-center ml-4 flex-grow">
            <span class="font-bold text-sm">Nike Dunk Low (Mummy)</span>
            <span class="text-red-500 text-xs">UK 9</span>
          </div>
        </div>
        <div class="flex justify-center w-1/5">
